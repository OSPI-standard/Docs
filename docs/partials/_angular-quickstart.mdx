...
<span class="mb-2 block">
  This quickstart shows how to add Ospi's {props.product} SDK to your{' '}
...
Now, you have established the connection with the Ospi meeting server successfully.
...
This is how typically the `app.module.ts` file looks like. This allows you to use Ospi's UI components in your component HTML files. For
...
2. Add the Ospi meeting component to your template file (`component.html`).
...
#### Add Ospi Meeting to the Template File
