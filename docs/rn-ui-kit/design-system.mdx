---
sidebar_position: 4
description: Details about the Design System in Ospi's React Native UI Kit.
---
...
<head>
  ...
  <meta
    name="description"
    content="Explore Ospi's design system for React Native, providing guidelines and components for consistent and visually appealing UI design."
  />
</head>
