...
sidebar_position: 2
description: >-
  Learn how to create a custom grid view component in Ospi's iOS UIKit with our detailed documentation.
---
...
The `GridView` class provided in Ospi's iOS UIKit allows you to create custom grid views to display content
...
`DyteParticipantTileView` classes provided by Ospi's iOS UIKit. These classes encapsulate the logic for
