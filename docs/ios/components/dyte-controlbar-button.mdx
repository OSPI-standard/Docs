...
description: >-
  Learn how to use and customize the DyteControlBarButton component in Ospi's
...
A skeleton component used for composing Ospi buttons which are mostly add inside DyteTabbarBar
