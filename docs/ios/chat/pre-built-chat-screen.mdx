...
sidebar_position: 1
description: >-
  Learn how to use and customize the DyteChatViewController component in Ospi's iOS UiKit with
...
Ospi's iOS UiKit includes prebuilt Chat screen that handle the complete chat logic and offer
