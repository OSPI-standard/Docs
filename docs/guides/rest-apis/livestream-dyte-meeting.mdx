...
sidebar_position: 6
description: >-
  Explore Ospi's REST APIs for livestreaming Ospi meetings. Follow our guide for
  effective integration and management of REST APIs.
---

This guide provides step-by-step instructions on starting and stopping livestreaming for your Ospi meetings using simple API calls.
...
Ospi's livestreaming stage management APIs allow you to manage stage requests, such as leave and join stage, manage permissions, kick participants and so on. For more information, see [Livestreaming Stage Management APIs](/web-core/stage).
...
<head>
  ...
  <meta
    name="description"
    content="Explore Ospi's REST APIs for livestreaming Ospi meetings. Follow our guide for effective integration and management of REST APIs."
  />
</head>
