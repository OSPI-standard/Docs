...
Now that you are familiar with the terminology of basic concepts on Ospi, we can take a look at how different offerings from Ospi come together. The key offerings are the REST API, core SDK , UIKit and a Developer Portal. Each of these serve different purposes and belong in different blocks of your application.
...
<head>
  ...
  <meta
    name="description"
    content="Explore the fundamental concepts of Ospi's Voice Conference capabilities. Follow our guide for a comprehensive understanding."
  />
</head>
