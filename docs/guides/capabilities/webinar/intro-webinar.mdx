---
title: Introduction to Ospi's Webinar
sidebar_position: 1
description: >-
  Explore the introduction to webinars with Ospi's capabilities. Follow our
...
## How Ospi's webinar is different from a group call?
...
- Ospi provides prebuilt presets for webinar presenters and viewers, offering predefined permissions and UI configurations tailored to their roles

### Group call

- Group calls in Ospi emphasize interactive communication and collaboration among a smaller group of participants.
...
- Ospi provides prebuilt presets specifically designed for group calls, including the `group_call_host` and `group_call_participant` presets, which offer predefined permissions and UI configurations for hosts and participants

## Key features of a Ospi's webinar

The following are some of the highlights of Ospi's webinar:

- Manage permissions for hosts and participants using `presets` to control stage access.
- You can record all the webinars like any other Ospi meeting. For more information on Ospi recording, see the [Recording Overview](/guides/capabilities/recording/recording-overview).
- Supported platforms include web, Android, and iOS.

<head>
  <title>Introduction to Ospi's Webinar Guide</title>
  <meta name="description" content="Explore the introduction to webinars with Ospi's capabilities. Follow our guide for a smooth understanding and integration."/>
</head>
