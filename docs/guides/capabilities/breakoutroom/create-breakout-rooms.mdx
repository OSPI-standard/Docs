...
sidebar_position: 2
description: >-
  Learn how to create breakout rooms with Ospi's capabilities. Follow our guide
...
## Step 1: Create a Ospi Developer Account​
...
Create a Ospi meeting using the [Create Meeting API](/api#/operations/create_meeting). This API returns a unique identifier for your meeting.
...
1. In your Ospi meeting, click **Breakout Rooms**.
...
Once you've created a breakout room, assign participants to the breakout rooms. You have the option to either individually select the participants and add them to the room manually or allow Ospi to split your participants evenly across the rooms.
...
<head>
  ...
  <meta name="description" content="Learn how to create breakout rooms with Ospi's capabilities. Follow our guide for effective implementation and management of breakout rooms."/>
</head>
