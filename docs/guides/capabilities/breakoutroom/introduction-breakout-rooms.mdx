---
title: Introduction to Ospi's Breakout Rooms
sidebar_position: 1
description: >-
  Get an introduction to breakout rooms with Ospi's capabilities. Follow our
...
Currently, Ospi breakout rooms are supported on the web only.

:::

## Key features of Ospi's breakout rooms

The following are some of the key features of Ospi's breakout rooms:
...
- You can record all the breakout sessions individually like any other Ospi meeting.
...
As mentioned earlier, each breakout session is a separate session. Each breakout session's recording is stored and managed separately, just like any other Ospi meeting. For more information on Ospi recording, see the [Recording Overview](/guides/capabilities/recording/recording-overview).

<head>
  <title>Introduction to Ospi's Breakout Rooms Guide</title>
  <meta name="description" content="Get an introduction to breakout rooms with Ospi's capabilities. Follow our guide for a smooth understanding and integration."/>
</head>
