...
You can easily integrate Ospi into your project without any SDK using an iFrame. An iFrame is a quick and easy way to embed a live video solution into your own website or application without modifying the underlying code.
...
<head>
  ...
  <meta name="description" content="Learn how to embed Ospi's features into your application. Follow our guide for seamless integration and embedding of Ospi capabilities."/>
</head>
