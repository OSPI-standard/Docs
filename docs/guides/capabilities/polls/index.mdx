...
Polls can be integrated in all kinds of Ospi meetings ranging from voice to livestream. Ospi's SDK makes it really simple to perform all operations required to create and run a poll. You can choose to use the Core SDK with Ospi's UIKit to create seamless poll interactions in a couple of minutes, or you can also use the Core SDK with your custom components.
