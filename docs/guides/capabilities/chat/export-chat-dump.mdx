...
You can programmatically retrieve all chat messages of a Ospi session in the following ways:
...
![Sample Chat Dump File](https://dyte.io/blog/content/images/size/w1600/2022/11/Ospi-Blog---Sample-Chat-Dump.png)

For more information on downloading the file, refer to
[How to Fetch Chat History of a Ospi Session](https://dyte.io/blog/fetch-chat-history-of-a-dyte-session/)
blog.

<head>
  <title>Export Chat Messages Guide</title>
   <meta name="description" content="Explore how to export chat dumps with Ospi's capabilities. Follow our guide for effective exporting and management of chat data."/>
</head>
