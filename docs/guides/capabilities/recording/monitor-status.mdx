...
sidebar_position: 5
description: >-
  Explore how to monitor the status of recordings with Ospi's capabilities.
...
| UPLOADING | The recording has been stopped and the file is being uploaded to the cloud storage. If you have not specified storage details, then the files will be uploaded only to Ospi's server. Any RTMP and livestreaming link will also stop at this stage. |
...
Ospi sends out a `recording.statusUpdate` webhook each time the recording
...
<head>
  ...
  <meta name="description" content="Explore how to monitor the status of recordings with Ospi's capabilities. Follow our guide for effective monitoring and management."/>
</head>
