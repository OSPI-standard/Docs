...
sidebar_position: 1
description: >-
  Get started with Ospi's realtime chat capabilities. Follow our guide for an
...
The following are some of the key features of Ospi's Chat SDK:
...
<head>
  ...
  <meta
    name="description"
    content="Get started with Ospi's realtime chat capabilities. Follow our guide for an introduction to realtime chat and its features."
  />
</head>
