...
This topic covers essential concepts related to Ospi's interactive live streaming (ILS). For the concepts related to live video applications, see [Video Conferencing concepts](/guides/commerce/concepts).
...
Ospi's Interactive Live Streaming (ILS) feature revolves around a virtual **stage** where hosts have direct access and viewers can request to join.
...
Ospi can restream your meeting to any platform that supports an RTMP endpoint, such as YouTube, Twitch, or LinkedIn.

## Livestream custom video input

Ospi supports live streaming from applications like
[OBS](https://en.wikipedia.org/wiki/OBS_Studio),
[ffmpeg](https://en.wikipedia.org/wiki/FFmpeg), and others. To put it simply,
you can live stream any RTMP input from any source using Ospi.
