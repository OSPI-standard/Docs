...
Plugins are one-click add-ons that can make your meetings more immersive and collaborative. Ospi provides a bunch of inbuilt plugins to choose from, you can also build your own plugins using the [Plugin SDK](../../plugin-sdk/).
