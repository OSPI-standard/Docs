...
In Ospi meetings, participants can create polls to gather opinions or make decisions collectively. 
...
Ospi's Android UI Kit provides a user-friendly prebuilt screen, [DyteCreatePollBottomSheet](/android/components/dyte-poll-form), 
for creating polls in a Ospi meeting. When using the DyteCreatePollBottomSheet, the poll creator can:
...
**Wrap Up**: With Ospi's prebuilt Create Poll screen, you can easily add interactive polls features
to your app, enhancing participant engagement in Ospi meetings.
