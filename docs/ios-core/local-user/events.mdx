...
title: Events
description: >-
  Explore local user events in iOS Core with Ospi Docs. Understand how to
...
<head>
  ...
  <meta
    name="description"
    content="Explore local user events in iOS Core with Ospi Docs. Understand how to leverage these events for enhanced user experiences within your app."
  />
</head>
