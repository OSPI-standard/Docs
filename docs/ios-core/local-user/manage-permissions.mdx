...
description: >-
  Learn how to manage permissions for local users in iOS Core with Ospi Docs.
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to manage permissions for local users in iOS Core with Ospi Docs. Ensure a smooth and secure user experience within your app."
  />
</head>
