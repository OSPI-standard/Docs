...
description: >-
  Create and manage polls in your iOS app using Ospi's documentation on
  Polls Creation.
sidebar_position: 2
tags:
  - ios-core
...
<head>
  ...
  <meta
    name="description"
    content="Create and manage polls in your iOS app using Ospi's documentation on Polls Creation."
  />
</head>
