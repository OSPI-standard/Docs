...
sidebar_position: 2
description: >-
  Learn how to manage stores in Ospi's Plugin SDK Usage documentation.
  Effectively handle and organize stores for seamless plugin development. Ospi
  Docs.
---
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to manage stores in Ospi's Plugin SDK Usage documentation. Effectively handle and organize stores for seamless plugin development."
  />
</head>
