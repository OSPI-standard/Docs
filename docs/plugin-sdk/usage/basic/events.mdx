...
sidebar_position: 2
description: >-
  Explore the basic events usage with Ospi Plugin SDK. Learn how to integrate
...
<head>
  ...
  <meta
    name="description"
    content="Explore the basic events usage with Ospi Plugin SDK. Learn how to integrate and leverage events for enhanced plugin functionality."
  />
</head>
