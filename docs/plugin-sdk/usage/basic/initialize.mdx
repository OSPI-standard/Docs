...
sidebar_position: 1
description: >-
  Initialize your plugin with Ospi Plugin SDK using our basic usage guide.
...
| pluginId  | string   | ID generated using Ospi CLI.                         | auto-filled by client SDK. | false        |
...
<head>
  ...
  <meta
    name="description"
    content="Initialize your plugin with Ospi Plugin SDK using our basic usage guide. Ensure a smooth start to your plugin integration process."
  />
</head>
