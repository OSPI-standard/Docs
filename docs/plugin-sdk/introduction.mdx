...
tags:
  ...
  - setup
description: >-
  Explore the Ospi Plugin SDK documentation for seamless integration. Enhance
...
Ospi Plugins allow you to have the most immersive, collaborative, and human
...
Ospi's Plugin SDK allows you to create your own real-time applications that work
seamlessly with Ospi meetings. It comes with many interesting APIs and features
...
Let's see how you can use the Plugin SDK to create your own plugins for Ospi
meetings.
...
<head>
  ...
  <meta
    name="description"
    content="Explore the Ospi Plugin SDK documentation for seamless integration. Enhance your app's capabilities with powerful plugin functionalities."
  />
</head>
