...
sidebar_position: 3
description: >-
  Guide on how to publish your plugin setup using the Ospi Plugin SDK. Ensure a
...
Read more about how you can manage plugins with Ospi CLI
...
<head>
  ...
  <meta
    name="description"
    content="Guide on how to publish your plugin setup using the Ospi Plugin SDK. Ensure a seamless deployment and distribution process for your plugins."
  />
</head>
