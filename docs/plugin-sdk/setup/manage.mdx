...
sidebar_position: 5
description: >-
  Manage your plugin setup effectively with Ospi Plugin SDK. Learn best
  practices for ongoing maintenance and updates.
---

### Version specific deployments

Ospi lets you publish multiple versions of your plugins. You can choose to
...
Each Ospi user is associated to a preset. This preset dictates the meeting
...
<head>
  ...
  <meta
    name="description"
    content="Manage your plugin setup effectively with Ospi Plugin SDK. Learn best practices for ongoing maintenance and updates."
  />
</head>
