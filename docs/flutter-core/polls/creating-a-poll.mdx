...
description: >-
  Learn how to create polls in Flutter using Ospi's features. Follow our
...
<head>
  ...
  <meta
    name="description"
    content="Learn how to create and vote on polls in Flutter using Ospi's features. Follow our documentation for seamless integration and effective poll creation."
  />
</head>
