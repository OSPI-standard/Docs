...
title: Introduction
description: >-
  Learn about the local user concept in Flutter with Ospi's documentation.
...
By default as soon as you join the meeting, Ospi SDK will produce your video and
...
<head>
  ...
  <meta
    name="description"
    content="Learn about the local user concept in Flutter with Ospi's documentation. Follow our guide for a smooth introduction and integration."
  />
</head>
