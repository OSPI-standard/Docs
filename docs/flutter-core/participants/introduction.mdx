...
description: >-
  ...
  with Ospi's documentation. Follow our guide for a smooth introduction.
sidebar_position: 1
tags:
  - flutter-core
  - participants
...
<head>
  ...
  <meta name="description" content="Learn about participants in Flutter and how to integrate participant features with Ospi's documentation. Follow our guide for a smooth introduction."/>
</head>
