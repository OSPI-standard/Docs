...
title: Introduction
description: >-
  Begin your journey with Ospi by exploring the basics of local user integration
...
- `presetName`: A strign value representing name of preset for local user. You can find this preset on Ospi Developer Portal
