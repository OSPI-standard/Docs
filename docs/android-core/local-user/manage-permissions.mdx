...
description: >-
  ...
  controlled user experience with Ospi Docs.
sidebar_position: 4
tags:
  - android-core
  - local-user
...
<head>
  ...
  <meta name="description" content="Learn how to manage permissions in your Android application for a secure and controlled user experience with Ospi Docs."/>
</head>
