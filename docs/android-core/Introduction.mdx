...
The Ospi Core SDK is designed to provide you with an easy way to incorporate live video, voice, livestream and chat capabilities 
...
SDKs that require knowledge of WebRTC functioning, Ospi's Core SDK provides a simple API that abstracts out the complexity, 
making it easier for developers to use. For instance, enabling video with Ospi's Core SDK is as easy as calling 
