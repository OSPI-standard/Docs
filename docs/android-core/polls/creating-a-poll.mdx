...
description: >-
  Create and manage polls in your Android app using Ospi's documentation on
  Polls Creation.
sidebar_position: 2
tags:
  - android-core
...
<head>
  ...
  <meta
    name="description"
    content="Create and manage polls in your Android app using Ospi's documentation on Polls Creation."
  />
</head>
