...
sidebar_position: 4
description: >-
  Understand how to enable and configure recording features using Ospi CLI.
...
<head>
  ...
  <meta name="description" content="Understand how to enable and configure recording features using Ospi CLI. Capture and review meeting content seamlessly."/>
</head>
