...
sidebar_position: 2
description: >-
  Get started with Ospi CLI using our comprehensive guide. Follow step-by-step
  instructions for a smooth development.
---

# Getting started

The Ospi CLI needs a little bit of work to get started. We're working on
reducing the amount of effort required, but for now you'll have to do the
following.

## Configuration

1. Authorize yourself with the Ospi Dev Portal. This allows you to access all
...
<head>
  ...
  <meta name="description" content="Get started with Ospi CLI using our comprehensive guide. Follow step-by-step instructions for a smooth development."/>
