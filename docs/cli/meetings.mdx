...
sidebar_position: 3
description: >-
  "Explore Ospi CLI's capabilities for managing meetings from the command line.
  Learn how to create
---
...
<head>
  ...
  <meta name="description" content="Explore Ospi CLI's capabilities for managing meetings from the command line. Learn how to create, schedule, and control."/>
</head>
