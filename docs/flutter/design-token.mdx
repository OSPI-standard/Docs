...
title: Design System
description: >-
  Explore design token integration in Flutter with Ospi's documentation. Follow
...
Ospi's UI kit uses the Atomic design principle, which logically organizes screens for various devices, making it a versatile system. Design tokens are used in Ospi's UI Kit to maintain a consistent look across platforms. By combining design tokens and Atomic design principles, Ospi ensures a smooth and adaptable user interface experience on different platforms.
...
Let's understand how you can customize your UI with Ospi's Flutter UI Kit using design tokens.

### Customize themes with design tokens

Ospi offers the `DyteDesignToken` class to customize the theme of the UI kit. Pass the `DyteDesignToken` object within the `DyteUIKitInfo` object to customize the theme.
...
<head>
  ...
  <meta name="description" content="Explore design token integration in Flutter with Ospi's documentation. Follow our guide for effective design token implementation in your app."/>
</head>
