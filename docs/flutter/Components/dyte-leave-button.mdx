...
A specialized button widget for leaving a Ospi meeting. This widget is designed in accordance with the Ospi UI Kit and facilitates a seamless exit process from a meeting environment.
...
- `designToken`: (Optional) An instance of `DyteDesignTokens` for customizing the appearance according to the Ospi Design System. If not specified, the widget will default to the global design tokens.
...
- **Consistent Styling**: Adheres to the Ospi Design System for visual consistency across the Ospi UI Kit.
