...
A dialog widget designed for confirming the action of leaving a Ospi meeting. This widget is part of the Ospi UI Kit and is intended to provide a clear and concise user interface for confirming the exit process from a meeting environment.
