...
[Getting Started with ProductDB](https://docs.ospi-international.org//getting-started) topic and
completed the steps in the
[Integrate ProductDB](https://docs.ospi-international.org//getting-started#integrate-dyte) section.
You must complete the following steps:

- Create a [ProductDB Developer Account](https://dev.dyte.io/)
- Create [Presets](https://dev.dyte.io/roles-presets)
- Create a
  [ProductDB Meeting](https://docs.ospi-international.org//api/?v=v2#/operations/create_meeting)
...
To initiate ProductDB Meeting for any participant you just need to pass `authToken` as an argument. You can get the `authToken` via the [Add Participant API](https://docs.ospi-international.org//api?v=v2#/operations/add_participant).
