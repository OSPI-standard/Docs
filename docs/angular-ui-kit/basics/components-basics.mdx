...
sidebar_position: 1
description: >-
  Learn the basics of components in Ospi's Angular UI Kit through our detailed
  documentation.
---
...
<head>
  ...
  <meta name="description" content="Learn the basics of components in Ospi's Angular UI Kit through our detailed documentation."/>
</head>
