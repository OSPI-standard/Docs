...
In order to replace Ospi's default icon set with your own, you can pass the link to your icon set in the `dyte-meeting` component like so.
...
<head>
  <title>Angular UI Kit Customize Meeting Icons</title>
    <meta name="description" content="Explore the process of customizing the Iconpack in Ospi's Angular UI Kit with our comprehensive documentation."/>
</head>
