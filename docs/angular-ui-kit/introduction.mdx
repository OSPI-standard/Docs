...
Ospi's UI Kit is a prebuilt design library of UI components that makes it easy
...
<head>
  ...
  <meta
    name="description"
    content="Discover the UI components available in Ospi's Angular UI Kit with our comprehensive documentation."
  />
</head>
