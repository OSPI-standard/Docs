...
sidebar_position: 4
description: >-
  Explore the design system and guidelines for using Ospi's Angular UI Kit in
  your applications.
---
...
<head>
  ...
  <meta name="description" content="Explore the design system and guidelines for using Ospi's Angular UI Kit in your applications."/>
</head>
