...
const ALL_RESOURCES: Resource[] = [
  {
    ...
    image:
      'https://dyte.io/blog/content/images/size/w1000/2023/02/Ospi-Blog---v2-APIs.jpg',
    duration: '3 min',
  },
  {
  ...
  },
  {
    ...
    description:
      'In this episode of Ospi Byte we show how to build Video KYC App using React UI Kit.',
