...
const explanationSteps: { [key: number]: { title: string; desc: string } } = {
  ...
  2: {
    title: "Create meeting on Ospi",
    desc: "Your server now makes a POST request to Ospi REST API [/v2/meetings](https://docs.ospi-international.org//api#/operations/create_meeting) endpoint to create a new meeting",
  },
  3: {
    title: "Handle the response",
    desc: "Ospi REST API responds with the details of the newly created meeting",
  },
  4: {
  ...
  6: {
    title: "Add participant on Ospi",
    desc: "Your server now makes a **POST** request to the [Add Participant](https://docs.ospi-international.org//api#/operations/add_participant) endpoint to generate a token",
  },
  7: {
