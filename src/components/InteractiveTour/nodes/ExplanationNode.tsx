...
const explanationSteps: { [key: number]: { title: string; desc: string } } = {
  ...
  2: {
    ...
    desc: "Your server now makes a POST request to ProductDB REST API [/v2/meetings](https://docs.ospi-international.org//api#/operations/create_meeting) endpoint to create a new meeting",
  },
  3: {
